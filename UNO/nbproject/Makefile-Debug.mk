...
${OBJECTDIR}/h/azar.o: h/azar.c
	${MKDIR} -p ${OBJECTDIR}/h
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/h/azar.o h/azar.c

${OBJECTDIR}/h/cartas.o: h/cartas.c
	${MKDIR} -p ${OBJECTDIR}/h
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/h/cartas.o h/cartas.c

${OBJECTDIR}/h/colores.o: h/colores.c
	${MKDIR} -p ${OBJECTDIR}/h
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/h/colores.o h/colores.c

${OBJECTDIR}/h/jugadores.o: h/jugadores.c
	${MKDIR} -p ${OBJECTDIR}/h
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/h/jugadores.o h/jugadores.c

${OBJECTDIR}/h/partida.o: h/partida.c
	${MKDIR} -p ${OBJECTDIR}/h
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/h/partida.o h/partida.c

${OBJECTDIR}/h/preguntas.o: h/preguntas.c
	${MKDIR} -p ${OBJECTDIR}/h
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/h/preguntas.o h/preguntas.c

${OBJECTDIR}/h/uno.o: h/uno.c
	${MKDIR} -p ${OBJECTDIR}/h
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/h/uno.o h/uno.c
